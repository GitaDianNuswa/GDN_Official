...
import { GraphQlInputNews } from "../../../graphql/GrpahQlNews";
...
export default function AddNews() {
  ...
  const { AddNews, loading, error } = GraphQlInputNews();
  ...
  const formik = useFormik({
    ...
    onSubmit: async () => {
      ...
      openAlert("success", "Berita Baru Berhasil Ditambahkan!!!");
      setTimeout(() => {
      ...
      <div className="relative">
        ...
        <div className="w-full">
          ...
          <div className="my-6 w-full h-fit">
            ...
            <WYSIWYG sendDataToParent={getDataFromChild} Values={"<p>Masukkan Berita</p>"}/>
